	...
	<div class="carousel-inner">
		<div class="item active">
			<img
				src="https://static.pexels.com/photos/225841/pexels-photo-225841.jpeg"
		...
		<div class="item">
			<img
				src="https://static.pexels.com/photos/237195/pexels-photo-237195.jpeg"
			...
			<div class="container">
				<div class="carousel-caption">
					...
					<p>
						<a class="btn btn-large btn-primary site-btn" href="#">Learn
							more</a>
					</p>
				</div>
			</div>
			...
			<div class="container">
				<div class="carousel-caption">
					...
					<p>With "mobile-first" there is now only one percentage-based
						grid.</p>
					<p>
						<a class="btn btn-large btn-primary site-btn" href="#">Browse
							gallery</a>
					</p>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-3">
				<div class="col-md-12 feature-box">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
						Proin sapien augue, dictum et gravida et, viverra et est.</p>
